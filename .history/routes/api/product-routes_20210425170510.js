...
router.put('/:id', async(req, res) => {
    try {
        const putProduct = await Product.put({
            {
                where: { id: req.params.id, product_id: req.params.product_id, price: req.params.price, stock: req.params.stock, category_id: req.params.category_id }
            }
        })
    }
